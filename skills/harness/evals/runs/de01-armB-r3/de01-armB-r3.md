...
- 成本 USD：preflight 0.046924999999999994／受測 0.6368／judge 0.4008／合計 1.0845　（null 表示該來源未回報，未以推估補完）
...
- run-start 量測：2026-09-04T12:58:15.265255+08:00
- run-end 量測：2026-09-04T13:07:08.364101+08:00
- raw trace manifest：10 個檔案，digest 513818e5dc12，核對通過

## 逐筆判定

| fixture | 類別 | routing | contract | 觸發 | 說明 |
|---|---|---|---|---|---|
| `judgment__positive-1` | positive | PASS | PASS | judgment |  |
| `judgment__positive-2` | positive | PASS | FAIL | judgment |  |
| `judgment__positive-4` | positive | PASS | FAIL | judgment |  |
| `judgment__positive-5` | positive | FAIL | FAIL | （無） | judgment: 預期觸發，實際未觸發 |
